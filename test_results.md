...
**Result: 8/8 test cases passed. Average response time: 1.73s.**

## Functional test cases

| # | Kind | Query | Result | Time (s) | Chunks | Answer (truncated) |
|---|------|-------|--------|----------|--------|---------------------|
| 1 | answerable | What programming languages does the SDK support? | ✅ PASS | 1.21 | 2 | The Foundry Local SDK supports Python, C#, JavaScript, and Rust programming languages. |
| 2 | answerable | How does Foundry Local run models? | ✅ PASS | 2.46 | 2 | Foundry Local runs AI models directly on your device without the need for cloud connectivity. It ach... |
| 3 | answerable | What is retrieval-augmented generation? | ✅ PASS | 2.65 | 2 | Retrieval-augmented generation is a method used in natural language processing where chat completion... |
| 4 | answerable | What hardware acceleration does Foundry Local use? | ✅ PASS | 1.86 | 2 | Foundry Local uses hardware acceleration through ONNX Runtime for efficient model inference on both ... |
...
| 8 | general | Tell me about Foundry Local. | ✅ PASS | 5.59 | 2 | Foundry Local is a platform that allows you to run Artificial Intelligence (AI) models directly on y... |
...
- Response times ranged 0.03s–5.59s, averaging 1.73s — within the plan's ~1-3s target for small models on a laptop.
...
- **Are sources cited?** 5/8 answers named a source from the retrieved context, as instructed by the system prompt.
