...
# Anchored to this file's directory, so running the script from anywhere
# uses (and reuses) the same practice database instead of scattering new
# empty ones around the filesystem.
DB_PATH = str(Path(__file__).resolve().parent / "practice.db")
